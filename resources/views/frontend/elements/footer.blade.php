                            ...
                            <div class="service-contain">
                                <div class="service-box">
                                    <div class="service-image">
                                        <img src="frontend/assets/svg/product.svg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                                ...
                                <div class="service-box">
                                    <div class="service-image">
                                        <img src="frontend/assets/svg/delivery.svg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                                ...
                                <div class="service-box">
                                    <div class="service-image">
                                        <img src="frontend/assets/svg/discount.svg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                                ...
                                <div class="service-box">
                                    <div class="service-image">
                                        <img src="frontend/assets/svg/market.svg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6">
                            <div class="footer-logo">
                                ...
                                <div class="footer-logo-contain">
                                    <p>We are a friendly bar serving a variety of cocktails, wines and beers. Our bar is
                                        a
                                        ...
                                        <ul>
                                            <li class="mb-0">
                                                <a href="https://play.google.com/store/apps" target="_blank">
                                                    <img src="frontend/assets/images/playstore.svg"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                            </li>
                                            <li class="mb-0">
                                                <a href="https://www.apple.com/in/app-store/" target="_blank">
                                                    <img src="frontend/assets/images/appstore.svg"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                            </li>
                                        </ul>
