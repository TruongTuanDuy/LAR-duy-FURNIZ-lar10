                    ...
                    <div class="row g-4">
                                        ...
                                        <div class="product-main no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/23.jpg" id="img-1"
                                                        data-zoom-image="frontend/assets/images/fashion/product/23.jpg"
                                                        class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/24.jpg"
                                                        data-zoom-image="frontend/assets/images/fashion/product/24.jpg"
                                                        class="
                                                        img-fluid image_zoom_cls-1 blur-up lazyload"
                                                        alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/25.jpg"
                                                        data-zoom-image="frontend/assets/images/fashion/product/25.jpg"
                                                        class="
                                                        img-fluid image_zoom_cls-2 blur-up lazyload"
                                                        alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/26.jpg"
                                                        data-zoom-image="frontend/assets/images/fashion/product/26.jpg"
                                                        class="
                                                        img-fluid image_zoom_cls-3 blur-up lazyload"
                                                        alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/23.jpg"
                                                        data-zoom-image="frontend/assets/images/fashion/product/23.jpg"
                                                        class="
                                                        img-fluid image_zoom_cls-4 blur-up lazyload"
                                                        alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="frontend/assets/images/fashion/product/24.jpg"
                                                        data-zoom-image="frontend/assets/images/fashion/product/24.jpg"
                                                        class="
                                                        img-fluid image_zoom_cls-5 blur-up lazyload"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-6 wow fadeInUp">
                            <div class="right-box-contain">
                                ...
                                <div class="product-contain border-0">
                                ...
                                <div class="product-package">
                                    <div class="product-radio-list select-package">
                                        <div class="form-check">
                                            <input type="radio" checked class="form-check-input" id="radio-0-0"
                                                name="radio-group-0" value="0">
                                            <label class="form-check-label" for="radio-0-0">28</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="radio-0-1"
                                                name="radio-group-0" value="1">
                                            <label class="form-check-label" for="radio-0-1">30</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input disabled" id="radio-0-2"
                                                name="radio-group-0" value="2" disabled="">
                                            <label class="form-check-label" for="radio-0-2">32</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="vendor-box">
                            <div class="vendor-contain">
                                <div class="vendor-image">
                                    <img src="frontend/assets/images/product/vendor.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                                ...
                                <ul>
                                        ...
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="frontend/assets/images/fashion/product/27.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="frontend/assets/images/fashion/product/28.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="frontend/assets/images/fashion/product/29.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                                            ...
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="frontend/assets/images/review/1.jpg">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="frontend/assets/images/review/2.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="frontend/assets/images/review/3.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="frontend/assets/images/review/4.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image people-text">
                                                                    <img alt="user" class="img-fluid "
                                                                        src="frontend/assets/images/review/5.jpg">
                                                                </div>
                                                            </div>
                                                            <div class="people-comment">
                                                                <div class="people-name"><a href="javascript:void(0)"
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="frontend/assets/images/cake/product/7.png" class="img-fluid"
                                                alt="">
                                        </a>
