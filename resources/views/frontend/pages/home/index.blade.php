            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="frontend/assets/images/vegetable/banner/1.jpg" class="bg-img blur-up lazyload"
                                alt="">
                        </div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="frontend/assets/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload"
                            alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="frontend/assets/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="frontend/assets/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="frontend/assets/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div class="col-xxl-3 col-xl-4 d-none d-xl-block">
                    <div class="p-sticky">
                            ...
                            <ul>
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/vegetable.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/meats.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/breakfast.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/frozen.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/biscuit.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/grocery.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/drink.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="frontend/assets/svg/1/milk.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="frontend/assets/images/vegetable/banner/11.jpg"
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain">
                            <img src="frontend/assets/images/vegetable/banner/15.jpg" class="bg-img blur-up lazyload"
                                alt="">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="frontend/assets/images/vegetable/banner/12.jpg"
                                        class="bg-img blur-up lazyload" alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="frontend/assets/images/vegetable/banner/13.jpg"
                                        class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="frontend/assets/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload"
                                alt="">
