        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.articleCategories.create') }}" class="btn btn-primary">
                                        ...
                                        @if (count($items) > 0)
                                            @foreach ($items as $key => $item)
                                                @php
                                                    ...
                                                    $linkOrdering = route('admin.articleCategories.change-ordering', [
                                                        'ordering' => 'value_new',
                                                        'id' => $id,
                                                    ]);
                                                    $linkStatus = route('admin.articleCategories.change-status', [
                                                        'status' => $status,
                                                        'id' => $id,
                                                    ]);
                                                @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a href="{{ route('admin.articleCategories.edit', ['item' => $item]) }}"
                                                            class="btn btn-orange btn-icon">
                                                            <i class="fa-regular fa-pen-to-square"></i></a>
                                                        <form class="d-inline-block form-delete" method="POST"
                                                            action="{{ route('admin.articleCategories.destroy', ['item' => $item]) }}">
                                                            @csrf
                                                            @method('DELETE')
